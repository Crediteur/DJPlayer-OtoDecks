	...
	component{ _component }
{
	...
	getLookAndFeel().setColour(Slider::thumbColourId, Colours::red.darker());
	getLookAndFeel().setColour(Slider::trackColourId, Colours::deeppink.darker(0.9f));
	getLookAndFeel().setColour(Slider::rotarySliderFillColourId, Colours::deeppink.darker(0.9f));
	getLookAndFeel().setColour(Slider::rotarySliderOutlineColourId, Colours::darkslateblue.darker(0.6f));
	getLookAndFeel().setColour(Slider::backgroundColourId, Colours::darkslateblue.darker(0.6f));
	getLookAndFeel().setColour(Slider::textBoxOutlineColourId, Colours::transparentBlack);
	getLookAndFeel().setColour(TextButton::buttonColourId, Colours::darkslateblue.darker(1.0f));
	getLookAndFeel().setColour(TextButton::buttonOnColourId, Colours::deeppink.darker(1.0f));
	...
	sliderColourSet1.setColour(Slider::trackColourId, Colours::mediumaquamarine.darker());
	sliderColourSet1.setColour(Slider::backgroundColourId, Colours::steelblue);
